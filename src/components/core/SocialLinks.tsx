...
import { Facebook, Instagram, MessageSquare, Twitter, Linkedin, Youtube, Globe } from 'lucide-react';
...
export function SocialLinks({ 
  ...
  const colorMap = {
    ...
    colored: 'group-[.facebook]:text-blue-600 group-[.instagram]:text-pink-600 group-[.twitter]:text-blue-400 group-[.linkedin]:text-blue-700 group-[.youtube]:text-red-600 group-[.tiktok]:text-black'
  };
  ...
  const bgColorMap = {
    ...
    colored: 'group-[.facebook]:bg-blue-600 group-[.instagram]:bg-pink-600 group-[.twitter]:bg-blue-400 group-[.linkedin]:bg-blue-700 group-[.youtube]:bg-red-600 group-[.tiktok]:bg-black text-white hover:opacity-90'
  };
  ...
  const borderColorMap = {
    ...
    colored: 'group-[.facebook]:border-blue-600 group-[.instagram]:border-pink-600 group-[.twitter]:border-blue-400 group-[.linkedin]:border-blue-700 group-[.youtube]:border-red-600 group-[.tiktok]:border-black'
  };
  
  // Apply styling based on variant
  const getBaseClasses = (platform: string) => {
    const baseClasses = ['transition-all duration-200 flex items-center justify-center group ' + platform];
    ...
    <div className={`flex ${containerSizeMap[size]} ${className}`}>
      ...
      {whatsapp && (
        <a
          ...
          aria-label="WhatsApp"
        >
          <MessageSquare className={sizeMap[size]} />
        </a>
      )}
      ...
      {tiktok && (
        <a
          ...
          aria-label="TikTok"
        >
          <TikTokIcon className={sizeMap[size]} />
        </a>
      )}
